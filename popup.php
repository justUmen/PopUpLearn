...
<body>
	...
	<div id="left_arrow_hide" onclick="document.getElementById('side_left').style.display='none'; document.getElementById('left_arrow').style.display='block';">🡄</div>
	<div id="right_arrow_hide" onclick="document.getElementById('side_right').style.display='none'; document.getElementById('right_arrow').style.display='block';">🡆</div>
