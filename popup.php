...
<body>
	...
	<div id="left_arrow" onclick="document.getElementById('side_left').style.display='block'; document.getElementById('side_left_hide').style.display='block'; document.getElementById('left_arrow').style.display='none';">🡆</div>
	<div id="right_arrow" onclick="document.getElementById('side_right').style.display='block'; document.getElementById('side_right_hide').style.display='block'; document.getElementById('right_arrow').style.display='none';">🡄</div>

	<div id="left_arrow_hide" onclick="document.getElementById('side_left').style.display='none'; document.getElementById('left_arrow').style.display='block'; document.getElementById('side_left_hide').style.display='block';">🡄</div>
	<div id="right_arrow_hide" onclick="document.getElementById('side_right').style.display='none'; document.getElementById('right_arrow').style.display='block'; document.getElementById('side_right_hide').style.display='block';">🡆</div>
