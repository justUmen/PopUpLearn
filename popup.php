...
<div id="sounds">
	<table style="text-align: center;"><tr><td style="width:45%;text-align:right;">
		...
		<a id="audio_2" style="height:53px;line-height: 40px;font-size:30px;vertical-align:middle" class='play-icon btn glyphicon glyphicon-volume-up' onclick='audio_play_2();return false' href='#' title='Play sound'> Enter</a>
	</td></tr></table>
</div>
