...
<body>
	...
	<div id="side_left">
		...
		<div id="wiktionary_1" class="tabcontent_1">
			<object data="https://en.wiktionary.org/wiki/<?php echo $LEFT; ?>#Chinese" width="100%" height="100%">
	      <embed src="https://en.wiktionary.org/wiki/<?php echo $LEFT; ?>#Chinese" width="100%" height="100%"> </embed>
	      Error: Embedded data could not be displayed.
	    </object>
		</div>

		<div id="wikipedia_1" class="tabcontent_1">
			<object data="https://<?php echo $LANGUAGE_WIKIPEDIA_1; ?>.wikipedia.org/wiki/<?php echo $LEFT; ?>#Chinese" width="100%" height="100%">
	      <embed src="https://<?php echo $LANGUAGE_WIKIPEDIA_1; ?>.wikipedia.org/wiki/<?php echo $LEFT; ?>#Chinese" width="100%" height="100%"> </embed>
	      Error: Embedded data could not be displayed.
	    </object>
		</div>
